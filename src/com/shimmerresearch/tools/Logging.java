...
/**
 * @author Joro Class performs logging of data to file on Android device SD
 *         memory
 * 
 */
public class Logging {
	...
	/**
	 * @param myName
	 *            is the file name which will be used
	 */
	 ...
	 * @param delimiter
	 * @param folderName
	 *            will create a new folder if it does not exist
	 */
	public Logging(String myName, String delimiter, String folderName) {
		...
		outputFile = new File(root, mFileName);
	}
